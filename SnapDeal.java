...
public class SnapDeal {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		//Training Shoes
				WebElement trainingShoes = driver.findElement(By.xpath("//div[text()='Training Shoes']/parent::a"));
				String trainingShoesString = trainingShoes.getText();
				trainingShoes.click();
				...
				builder.release().perform();
				Thread.sleep(2000);
				driver.findElement(By.xpath("//label[@for='Color_s-Gray']")).click();
				...
				File dstn = new File("./snaps/shoe.png");
